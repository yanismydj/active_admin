  ...
  module Views
    ...
    class IndexAsTable < ActiveAdmin::Component
      ...
      class IndexTableFor < ::ActiveAdmin::Views::TableFor
        ...
        def id_column
          column('ID', :sortable => :id){|resource| link_to resource.id, resource_path(resource, :cluster => resource.cluster_name), :class => "resource_id_link"}
        end
        ...
        def default_actions(options = {})
          ...
          column options[:name] do |resource|
            ...
            if controller.action_methods.include?('show')
              links += link_to I18n.t('active_admin.view'), resource_path(resource, :cluster => resource.cluster_name), :class => "member_link view_link"
            end
            if controller.action_methods.include?('edit')
              links += link_to I18n.t('active_admin.edit'), edit_resource_path(resource, :cluster => resource.cluster_name), :class => "member_link edit_link"
            end
            if controller.action_methods.include?('destroy')
              links += link_to I18n.t('active_admin.delete'), resource_path(resource, :cluster => resource.cluster_name), :method => :delete, :confirm => I18n.t('active_admin.delete_confirmation'), :class => "member_link delete_link"
            end
            links
          end
        end
